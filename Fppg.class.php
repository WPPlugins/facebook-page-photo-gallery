...
/**
     ...
     * @return type
     */
    public static function embedPhotosAjax($albumId, $args, $options=array(),$paging=25,$size='large',$scroll=false,$template = "") {
...
public function getPhotosAjax(){ 
   ...
   echo json_encode($this->embedPhotosAjax($id,$args,$options));
   exit();
}
